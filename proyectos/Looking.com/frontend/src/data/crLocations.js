const COSTA_RICA_LOCATIONS = {
  ...
  Heredia: {
    ...
    Sarapiquí: ["Puerto Viejo", "La Virgen", "Las Horquetas", "Llanuras de Gaspar", "Cureña"]
  },

  Guanacaste: {
    Liberia: ["Liberia", "Cañas Dulces", "Mayorga", "Nacascolo", "Curubandé"],
    Nicoya: ["Nicoya", "Mansión", "San Antonio", "Quebrada Honda", "Sámara", "Nosora", "Belén de Nosarita"],
    ...
    Cañas: ["Cañas", "San Miguel", "Bebedero", "Porozal"],
    Abangares: ["Las Juntas", "Sierra", "San Juan", "Colorado"],
    Tilarán: ["Tilarán", "Quebrada Grande", "Tronadora", "Santa Rosa", "Líbano", "Tierras Morenas", "Arenal", "Cabeceras"],
    Nandayure: ["Carmona", "Zapotal", "San Pablo", "Provenir", "Bejuco"],
    "La Cruz": ["La Cruz", "Santa Cecilia", "La Garita", "Santa Elena"],
    Hojancha: ["Hojancha", "Monte Romo", "Puerto Carrillo", "Huacas", "Matambú"]
  },

  Puntarenas: {
    Central: ["Puntarenas", "Pitahaya", "Chomes", "Lepanto", "Paquera", "Manzanillo", "Guacimal", "Barranca", "Isla del Coco", "Cóbano", "Chacarita", "Chira", "Acapulco", "El Roble", "Arancibia"],
    Esparza: ["Espíritu Santo", "San Juan Grande", "Macacona", "San Rafael", "San Jerónimo", "Caldera"],
    "Buenos Aires": ["Buenos Aires", "Volcán", "Potrero Grande", "Buroca", "Pilas", "Colinas", "Chánguena", "Biolley", "Brunka"],
    ...
    "Coto Brus": ["San Vito", "Sabalito", "Aguabuena", "Limoncito", "Pittier", "Gutiérrez Braum"],
    Parrita: ["Parrita"],
  ...
  Limón: {
    ...
    Guácimo: ["Guácimo", "Mercedes", "Pocora", "Río Jimenez", "Duacarí"]
  },
};
